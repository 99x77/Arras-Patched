(() => {
	...
	var dc = [, (Ma, Fa, Y) => {
		...
		let b = !1;
		window.Arras = l => "string" === typeof l && (b = b || "X8KDa199MTItU+gyqYWU+GIExelEY1yYwZU0xzRF104=" === u.hash(l, "latin1", "base64")) ? Z : {
			get graphical() {
				let v = Z.Db.h;
				return {
					get screenshotMode() {
			...
			let l = new ArrayBuffer(65536),
				...
				C = function (Ka, Qa, Wa) {
					function Pa(A) {
						...
						n = ea + n + (p >>> 6 ^ p >>> 11 ^ p >>> 25 ^ p << 26 ^ p << 21 ^ p << 7) + (q ^ p &
							(t ^ q)) + 1899447441 | 0;
						k = k + n | 0;
						...
						r = r + p | 0;
						p = p + (t & q ^ n & (t ^ q)) + (t >>> 2 ^ t >>> 13 ^ t >>> 22 ^ t << 30 ^ t << 19 ^ t << 10) |
							0;
						...
						p = p + r | 0;
						r = r +
							(f & m ^ k & (f ^ m)) + (f >>> 2 ^ f >>> 13 ^ f >>> 22 ^ f << 30 ^ f << 19 ^ f << 10) | 0;
						...
						f = f + t | 0;
						t = t + (q & n ^ r & (q ^ n)) + (q >>> 2 ^ q >>> 13 ^ q >>> 22 ^ q << 30 ^ q << 19 ^ q << 10) | 0;
						p = ma + p + (f >>> 6 ^ f >>> 11 ^ f >>> 25 ^ f <<
							26 ^ f << 21 ^ f << 7) + (k ^ f & (m ^ k)) + 1925078388 | 0;
						r = r + p | 0;
						...
						k = k + n | 0;
						n = n + (r & f ^ m & (r ^ f)) + (r >>> 2 ^ r >>> 13 ^ r >>> 22 ^ r << 30 ^ r << 19 ^ r << 10) | 0;
						ka = (ya >>> 7 ^ ya >>> 18 ^ ya >>> 3 ^ ya << 25 ^ ya <<
							14) + (V >>> 17 ^ V >>> 19 ^ V >>> 10 ^ V << 15 ^ V << 13) + ka + qa | 0;
						...
						p =
							ca + p + (f >>> 6 ^ f >>> 11 ^ f >>> 25 ^ f << 26 ^ f << 21 ^ f << 7) + (k ^ f & (m ^ k)) + 770255983 | 0;
						r = r + p | 0;
						p = p + (t & q ^ n & (t ^ q)) + (t >>> 2 ^ t >>> 13 ^ t >>> 22 ^ t << 30 ^ t << 19 ^ t << 10) | 0;
						...
						m = ta + m + (n >>> 6 ^ n >>> 11 ^ n >>> 25 ^ n << 26 ^ n << 21 ^ n << 7) + (f ^ n &
							(r ^ f)) + 1555081692 | 0;
						q = q + m | 0;
						m = m + (k & p ^ t & (k ^ p)) + (k >>> 2 ^ k >>> 13 ^ k >>> 22 ^ k << 30 ^ k << 19 ^ k << 10) | 0;
						...
						p = p + r | 0;
						r = r + (f & m ^ k & (f ^ m)) +
							(f >>> 2 ^ f >>> 13 ^ f >>> 22 ^ f << 30 ^ f << 19 ^ f << 10) | 0;
						...
						q = q + (n & r ^ f & (n ^ r)) + (n >>> 2 ^ n >>> 13 ^ n >>> 22 ^ n << 30 ^ n << 19 ^ n << 10) | 0;
						qa =
							(ma >>> 7 ^ ma >>> 18 ^ ma >>> 3 ^ ma << 25 ^ ma << 14) + (wa >>> 17 ^ wa >>> 19 ^ wa >>> 10 ^ wa << 15 ^ wa << 13) + qa + ca | 0;
						...
						r = r + p | 0;
						p = p + (t & q ^ n & (t ^ q)) + (t >>> 2 ^ t >>> 13 ^ t >>> 22 ^ t << 30 ^ t << 19 ^ t << 10) | 0;
						P = (L >>> 7 ^ L >>> 18 ^ L >>> 3 ^ L << 25 ^ L << 14) + (qa >>> 17 ^ qa >>> 19 ^ qa >>>
							10 ^ qa << 15 ^ qa << 13) + P + ta | 0;
						...
						f = A + f + (q >>> 6 ^ q >>> 11 ^ q >>> 25 ^ q << 26 ^ q << 21 ^ q <<
							7) + (r ^ q & (n ^ r)) + 338241895 | 0;
						t = t + f | 0;
						f = f + (m & k ^ p & (m ^ k)) + (m >>> 2 ^ m >>> 13 ^ m >>> 22 ^ m << 30 ^ m << 19 ^ m << 10) | 0;
						V = (ea >>> 7 ^ ea >>> 18 ^ ea >>> 3 ^ ea << 25 ^ ea << 14) + (L >>> 17 ^ L >>> 19 ^ L >>> 10 ^ L << 15 ^ L << 13) + V + wa | 0;
						...
						t = t + (q & n ^ r & (q ^ n)) + (q >>> 2 ^ q >>> 13 ^ q >>> 22 ^ q << 30 ^ q << 19 ^ q << 10) | 0;
						ca = (ba >>> 7 ^ ba >>>
							18 ^ ba >>> 3 ^ ba << 25 ^ ba << 14) + (ka >>> 17 ^ ka >>> 19 ^ ka >>> 10 ^ ka << 15 ^ ka << 13) + ca + P | 0;
						...
						n = n + k | 0;
						k = k + (p & t ^ q & (p ^ t)) + (p >>> 2 ^ p >>> 13 ^ p >>> 22 ^ p << 30 ^ p << 19 ^ p << 10) | 0;
						ta = (ua >>> 7 ^ ua >>> 18 ^ ua >>> 3 ^ ua << 25 ^ ua << 14) + (ca >>> 17 ^ ca >>> 19 ^ ca >>>
							10 ^ ca << 15 ^ ca << 13) + ta + A | 0;
						...
						va = (wa >>> 7 ^ wa >>> 18 ^ wa >>> 3 ^ wa << 25 ^ wa << 14) + (ta >>> 17 ^ ta >>> 19 ^ ta >>> 10 ^ ta << 15 ^ ta << 13) + va + ea | 0;
						r = va + r + (t >>> 6 ^ t >>> 11 ^
							t >>> 25 ^ t << 26 ^ t << 21 ^ t << 7) + (n ^ t & (q ^ n)) + 2730485921 | 0;
						p = p + r | 0;
						r = r + (f & m ^ k & (f ^ m)) + (f >>> 2 ^ f >>> 13 ^ f >>> 22 ^ f << 30 ^ f << 19 ^ f << 10) | 0;
						wa = (xa >>> 7 ^ xa >>> 18 ^ xa >>> 3 ^ xa << 25 ^ xa << 14) + (ua >>> 17 ^ ua >>> 19 ^ ua >>> 10 ^ ua << 15 ^ ua << 13) + wa + ka | 0;
						...
						n = n + (r & f ^ m & (r ^ f)) + (r >>> 2 ^ r >>> 13 ^ r >>> 22 ^ r << 30 ^ r << 19 ^ r << 10) | 0;
						xa = (qa >>> 7 ^ qa >>> 18 ^ qa >>> 3 ^ qa << 25 ^ qa << 14) + (va >>> 17 ^ va >>> 19 ^ va >>> 10 ^ va << 15 ^ va << 13) + xa + ya | 0;
						q = xa + q + (k >>> 6 ^ k >>> 11 ^ k >>> 25 ^ k << 26 ^ k << 21 ^ k << 7) + (t ^ k & (p ^ t)) + 3259730800 |
							0;
						m = m + q | 0;
						q = q + (n & r ^ f & (n ^ r)) + (n >>> 2 ^ n >>> 13 ^ n >>> 22 ^ n << 30 ^ n << 19 ^ n << 10) | 0;
						...
						q = q + m | 0;
						m = m + (k & p ^ t & (k ^ p)) + (k >>> 2 ^ k >>> 13 ^ k >>> 22 ^ k << 30 ^ k << 19 ^ k << 10) | 0;
						A = (V >>> 7 ^ V >>> 18 ^ V >>> 3 ^ V << 25 ^ V << 14) + (P >>> 17 ^
							P >>> 19 ^ P >>> 10 ^ P << 15 ^ P << 13) + A + va | 0;
						...
						r = r + (f & m ^ k & (f ^ m)) + (f >>> 2 ^ f >>> 13 ^ f >>> 22 ^ f << 30 ^ f << 19 ^ f << 10) | 0;
						ea = (ka >>> 7 ^ ka >>> 18 ^ ka >>> 3 ^ ka << 25 ^ ka << 14) + (A >>> 17 ^ A >>> 19 ^ A >>> 10 ^ A << 15 ^ A << 13) + ea + xa | 0;
						n = ea + n + (p >>> 6 ^ p >>> 11 ^ p >>> 25 ^
							p << 26 ^ p << 21 ^ p << 7) + (q ^ p & (t ^ q)) + 506948616 | 0;
						k = k + n | 0;
						n = n + (r & f ^ m & (r ^ f)) + (r >>> 2 ^ r >>> 13 ^ r >>> 22 ^ r << 30 ^ r << 19 ^ r << 10) | 0;
						ka = (ya >>> 7 ^ ya >>> 18 ^ ya >>> 3 ^ ya << 25 ^ ya << 14) + (V >>> 17 ^ V >>> 19 ^ V >>> 10 ^ V << 15 ^ V << 13) + ka + qa | 0;
						...
						f = f + t | 0;
						t =
							t + (q & n ^ r & (q ^ n)) + (q >>> 2 ^ q >>> 13 ^ q >>> 22 ^ q << 30 ^ q << 19 ^ q << 10) | 0;
						ca = (ba >>> 7 ^ ba >>> 18 ^ ba >>> 3 ^ ba << 25 ^ ba << 14) + (ka >>> 17 ^ ka >>> 19 ^ ka >>> 10 ^ ka << 15 ^ ka << 13) + ca + P | 0;
						...
						n = n + k | 0;
						k = k + (p & t ^ q & (p ^ t)) + (p >>> 2 ^ p >>> 13 ^ p >>> 22 ^ p << 30 ^ p << 19 ^
							p << 10) | 0;
						ta = (ua >>> 7 ^ ua >>> 18 ^ ua >>> 3 ^ ua << 25 ^ ua << 14) + (ca >>> 17 ^ ca >>> 19 ^ ca >>> 10 ^ ca << 15 ^ ca << 13) + ta + A | 0;
						...
						t = t + f | 0;
						f = f + (m & k ^ p & (m ^ k)) + (m >>> 2 ^ m >>> 13 ^ m >>> 22 ^ m << 30 ^ m << 19 ^ m << 10) | 0;
						va = (wa >>> 7 ^ wa >>> 18 ^ wa >>> 3 ^ wa << 25 ^ wa << 14) +
							(ta >>> 17 ^ ta >>> 19 ^ ta >>> 10 ^ ta << 15 ^ ta << 13) + va + ea | 0;
						...
						k = k + n | 0;
						n = n + (r & f ^ m & (r ^ f)) + (r >>> 2 ^ r >>> 13 ^ r >>> 22 ^ r << 30 ^ r << 19 ^ r << 10) | 0;
						xa = (qa >>> 7 ^ qa >>> 18 ^ qa >>> 3 ^ qa << 25 ^ qa << 14) + (va >>> 17 ^ va >>> 19 ^ va >>> 10 ^ va << 15 ^ va << 13) + xa + ya |
							0;
						...
						t = t + (q & n ^ r & (q ^ n)) + (q >>> 2 ^ q >>> 13 ^ q >>> 22 ^ q << 30 ^ q << 19 ^ q << 10) | 0;
						ma = (P >>> 7 ^ P >>> 18 ^ P >>> 3 ^ P << 25 ^ P << 14) + (xa >>> 17 ^ xa >>> 19 ^ xa >>> 10 ^ xa << 15 ^ xa << 13) + ma + ba | 0;
						p = ma + p + (f >>> 6 ^ f >>> 11 ^ f >>> 25 ^ f << 26 ^ f << 21 ^ f << 7) + (k ^
							f & (m ^ k)) + 2428436474 | 0;
						r = r + p | 0;
						p = p + (t & q ^ n & (t ^ q)) + (t >>> 2 ^ t >>> 13 ^ t >>> 22 ^ t << 30 ^ t << 19 ^ t << 10) | 0;
						P = (L >>> 7 ^ L >>> 18 ^ L >>> 3 ^ L << 25 ^ L << 14) + (qa >>> 17 ^ qa >>> 19 ^ qa >>> 10 ^ qa << 15 ^ qa << 13) + P + ta | 0;
					...
					return {
						...
						digest: function (A, V, ea) {
							...
							N[A | 63] = ab << 3 & 255;
							Pa(A);
							~ea && (A = ea | 0, N[A | 0] = $a >>> 24, N[A | 1] = $a >>> 16 & 255, N[A | 2] = $a >>> 8 & 255, N[A | 3] = $a & 255, N[A | 4] = gb >>> 24, N[A | 5] = gb >>> 16 & 255, N[A | 6] = gb >>> 8 & 255, N[A | 7] = gb & 255, N[A | 8] = jb >>> 24, N[A | 9] = jb >>> 16 & 255, N[A | 10] = jb >>> 8 & 255, N[A | 11] = jb & 255, N[A | 12] = T >>> 24, N[A | 13] = T >>> 16 & 255, N[A | 14] = T >>> 8 & 255, N[A | 15] = T & 255, N[A | 16] = Ra >>> 24, N[A | 17] = Ra >>> 16 & 255, N[A | 18] = Ra >>> 8 & 255, N[A |
								19] = Ra & 255, N[A | 20] = D >>> 24, N[A | 21] = D >>> 16 & 255, N[A | 22] = D >>> 8 & 255, N[A | 23] = D & 255, N[A | 24] = ib >>> 24, N[A | 25] = ib >>> 16 & 255, N[A | 26] = ib >>> 8 & 255, N[A | 27] = ib & 255, N[A | 28] = hb >>> 24, N[A | 29] = hb >>> 16 & 255, N[A | 30] = hb >>> 8 & 255, N[A | 31] = hb & 255);
							return ka | 0
						}
					}
				}({
			...
			jc() {
				if (!this.hc) {
					...
					setInterval(() => {
						let Ka = this.ic();
						da !== !!Ka &&
							(da = !!Ka, b(da ? "Controller connected." : "Controller disconnected."));
						if (Ka) {
			...
			rd(l) {
				...
				if (u.M && u.Vb <= Date.now()) this.vb();
					...
					for (let na of l.changedTouches) {
						...
						da || (C = C.x < this.raw.width / 2, null === this.N && C ? this.N = v : null !== this.j || C || (this.j = v, v = 500 >= Date.now() -
							this.kc, this.kc = Date.now(), this.set(4, !0), this.set(6, [!1, !0, !1, null !== this.A, v][u.ea])))
					}
					this.mc(l)
				}
			}
			mc(l) {
				...
				for (let C of l.changedTouches) {
					...
					if (this.N === v) {
						...
						l /= na;
						this.Wb(v, l)
					} else this.j === v && (v = 4 * (l.x - 5 * this.raw.width / 6), l = 4 * (l.y - 2 * this.raw.height / 3), 2 !== u.ea ? this.setPosition(v, l) : v > -this.raw.width / 2 && v < this.raw.width / 2 && l > -this.raw.height / 2 && l < this.raw.height / 2 ? (this.setPosition(v,
						l), this.set(6, !1)) : (this.setPosition(-v, -l), this.set(6, !0)))
				}
			}
			lc(l) {
				l.preventDefault();
		...
		Ma.exports = {
			...
			wb: {
				...
				show(b = this.D) {
					...
					this.Ga = !0;
					this.D = b;
					"adinplay" === this.D ? Y().cmd.display.push(() =>
						window.aipDisplayTag.display("arras-io_336x280")) : "nitropay" === this.D ? (Z("ad-spawn", "block"), u().createAd("ad-spawn", {
							refreshLimit: 10,
							refreshTime: 30,
							renderVisibleOnly: !1,
			...
			Na: {
				...
				show(b = this.D) {
					...
					if ("adinplay" === this.D) Y().cmd.display.push(() => window.aipDisplayTag.display("arras-io_728x90"));
						...
						b = [];
						"nitropay-mobile" === this.D ? b.push([320, 50]) : (1440 <= window.innerWidth && 680 <= window.innerHeight && b.push([970, 250]), 1440 <= window.innerWidth &&
							b.push([970, 90]), b.push([728, 90]), 700 <= window.innerHeight && b.push([336, 280]), 680 <= window.innerHeight && b.push([300, 250]));
					...
					for (var b of u) {
						...
						if (0 === b || !1 === b) l = 0;
							...
							for (var v = 0; v < b.length; v++)
								if ("\u00ff" < b.charAt(v)) l = !0;
								else if ("\x00" === b.charAt(v)) throw console.error("Null containing string",
									b), Error("Null containing string");
	...
	(() => {
		bb.r = Ma => {
			"undefined" !==
				typeof Symbol && Symbol.toStringTag && Object.defineProperty(Ma, Symbol.toStringTag, {
					value: "Module"
				});
	...
	(() => {
			...
			D = a => {
				...
				switch (a) {
					...
					case 35:
						return "#ffd300";
					case 36:
						return Ra("#ff1000 #ff9000 #ffd300 #00e00b #226ef6 #a913cf".split(" ")[Math.floor(Date.now() / 200 % 6)], "#ff9000 #ffd300 #00e00b #226ef6 #a913cf #ff1000".split(" ")[Math.floor(Date.now() /
							200 % 6)], Date.now() / 200 % 1);
					case 37:
		...
		let ba = [],
			...
			P = b.ge = {
				latency: {
					...
					xd() {
						return 1 >= this.T.length ? 0 : Math.max(0, (this.T[this.T.length - 1] - this.T[0]) / (this.T.length - 1) +
							T.ob.offset)
					}
				},
				s: {
		...
		Nb.Md().then(a => {
			...
			for (let a of b.ua) {
				let [, c, d] =
					a.code.split("-"), [, g, h] = d.match(/([fds0-9])([dmastp]?)$/) || [null, "", ""], y = b.Ra[1][c][2];
				a.sort = {
					qa: null == y || "" === g ? -13 : y,
				...
				for (let y = 0; y < a.children.length; y++) {
					...
					h[I] = () => {
						if (B !== d) {
							...
							g.classList.add(I);
							d = B;
							c.scrollLeft = B.offsetLeft - a.offsetLeft + B.offsetWidth / 2 - c.offsetWidth /
								2
						}
					};
			...
			Fb = (a, c = null) => {
				...
				if ("poll" === g || "event-poll" === g) {
					...
					for (var Q of a.slice(2)) {
						...
						if (I)
							for (var S of Q.split("|")) S =
								S.trim(), g = document.createElement("td"), "X" === S ? g.appendChild(d()) : (B = S.match(/^:*/)[0].length, g.colSpan = B + 1, g.innerHTML = S.slice(B)), a.appendChild(g);
					...
					for (a = 0; a < S.length; a++) {
						I = S[a];
						if (!I.href) continue;
						let M = I.href.lastIndexOf("#"); -
							1 !== M && (M = I.href.slice(M + 1), "options-menu" === M ? S[a].addEventListener("click", E => {
								E.preventDefault();
								gc()
		...
		if (!b.mobile) {
			...
			for (let E of c.rows)
				for (let e of E.cells) {
					...
					a[G.key] && (w.innerText = G.ha = a[G.key][0], b[F] = G.U = a[G.key][1], G.L &&
						(b.L[G.L] = G.ha));
					y.push(G)
				}
			let B = () => y.some(({
			...
			Sb = (() => {
				...
				const h = {
					...
					y = class {
						...
						update() {
							for (let e of this.o)
								if (e.Jb && (e.Jb = !1, e.ga += e.Yc), e.ga || e.position) e.ga -= .2 * e.position, e.position += e.ga, 0 > e.position && (e.position = 0, e.ga = -e.ga), 0 < e.ga &&
									(e.ga *= .5)
						}
						ad(e, w) {
							e = this.get(e);
					...
					B = class {
						...
						zc() {
							...
							return "injured" === this.b || "killed" === this.b ? Math.max(0, 1 - (Date.now() -
								this.time) / 80) : 0
						}
					},
					I = e => {
					...
					Q = e => {
						...
						F & 16 && (G = e.R, e.R = h.next() / 255, e.R < G &&
							(H = !0));
					...
					S = () => {
						...
						e = performance.now();
						for (let w of ba) w.Hc &&
							(w.a.status.set(1 === w.K ? "dying" : "killed"), w.de = 0 === w.a.status.ta() || !Hb(w.a.Ja.get(e) - fa.a.x, w.a.Ka.get(e) - fa.a.y, w.size) && 0 === w.o.Ta() && 0 === w.m.length && !w.a.Sa);
						ba = ba.filter(w => !w.de);
					...
					M = {
						...
						J() {
							...
							X && (X = parseInt(h.next(), 36), f.F[0].amount = X / 68719476736 & 15, f.F[1].amount = X / 4294967296 & 15, f.F[2].amount =
								X / 268435456 & 15, f.F[3].amount = X / 16777216 & 15, f.F[4].amount = X / 1048576 & 15, f.F[5].amount = X / 65536 & 15, f.F[6].amount = X / 4096 & 15, f.F[7].amount = X / 256 & 15, f.F[8].amount = X / 16 & 15, f.F[9].amount = X & 15);
							Ba && (f.cb = h.next());
							za && (f.dc = h.next());
				...
				if (b.B && !Tb) {
					...
					if (hc()) b.ba = !0, b.message = "Cheat detected. Please disable any extensions you have enabled that might interfere with the game.";
						...
						console.warn("WebSocket error",
							c), b.ba = !0, b.message = "Server invalid. Maybe another server will work."
					...
					if (a) {
						...
						if (S || M) {
							...
							let E = Math.max(3, .2 * I),
								...
								F = S + 2 * E;
							M || e < F || e > 2.5 * F ? (e = Math.ceil(1.25 * F), w = Math.ceil(I + 2 * E), this.A = e, this.j = w, this.b.canvas.width = e, this.b.canvas.height =
								w, this.b.lineWidth = E, this.b.font = `bold ${I}px Ubuntu`, this.b.textBaseline = "middle", this.b.strokeStyle = D(9), this.b.fillStyle = h, this.b.lineCap = "round", this.b.lineJoin = "round") : this.b.clearRect(0, 0, e, w);
							h = (e - S) / 2;
							I = w / 2;
		...
		let Ta = (a, c, d, g, h = !1) => {
			h ? x.strokeRect(a, c, d, g) : x.fillRect(a,
				c, d, g)
		},
			xb = (a, c, d, g = !1) => {
				x.beginPath();
		...
		const Wb = (() => {
					...
					if (0 !== B) {
						...
						for (za = 0; za < F.o.length; za++) {
							...
							Va = E.o.get(za).position; {
								...
								h.lineTo(Ba + Ja * Math.cos(Aa + Math.PI + oa), Va + Ja * Math.sin(Aa + Math.PI + oa));
								h.lineTo(Ba + ha *
									Math.cos(Aa - W), Va + ha * Math.sin(Aa - W));
								h.closePath();
			...
			ic = new RegExp(atob("ZnVja3xzaGl0fHBpc3N8ZGlja3xjb2NrfFxiYXNzfGFyc2V8Yml0Y2h8YmFzdGFyZHxib2xsb2Nrc3xkYW1ufGN1bnR8Y3JhcA=="),
				"i"),
		...
		let jc = (a, c, d, g, h) => {
			if (!(.05 > h)) {
				...
				if (d.jb) {
					...
					let S = d.a.R.get(),
						M = 0 <= S;
					if (1 > Q || M && 1 > S) g = 3 * Math.max(1, g), I = c + 1.1 * I + 4 * g, x.globalAlpha = h * h * y, T.h.tb && M ? (Ya(a - B, a + B, I, 3 * g, D(9)), Ya(a - B, a - B + 2 * B * Q, I + .5 * g, g, D(1)), x.globalAlpha *= .7, Ya(a - B, a - B + 2 * B * S, I - .5 * g, g, D(0))) : (Ya(a - B, a + B, I, 2 * g, D(9)), Ya(a - B, a - B + 2 * B * Q, I, g, D(1)), M && (x.globalAlpha *= .3 + .3 * S, Ya(a -
						B, a - B + 2 * B * S, I, g, D(0)))), x.globalAlpha = y
				}
		...
		const kc = (() => {
			...
			return W => {
				...
				let oa = Math.max(b.c, 16 * b.f / 9) / b.rb * T.J.scale,
					...
					if (T.h.sb && 2.5 < K) {
						...
						if (L.S) {
							...
							for (let z = (b.f / 2 - Xa) %
								K - J; z < b.f + J; z += K) x.moveTo(-J, z), x.lineTo(J + b.c, z)
						} else {
				...
				if (L.pc) {
					...
					if (K) {
						...
						for (let R of pa) {
							let Ha = K.a.ja,
								Ua = ra + R.offset * Math.cos(R.direction + R.angle + Ha) + R.length /
									2 * Math.cos(R.angle + Ha),
				...
				if (T.J.enabled) {
					...
					if (b.Yb) {
						...
						if (Kb && Kb.ra) {
							...
							for (let [K, J] of Ab) {
								...
								x.moveTo(Math.round(b.c / 2 + (K.x - qb.width / 2) * tb + 1 + .5 * eb) + .5, Math.round(b.f /
									2 + (K.y - qb.height / 2) * tb + 1 + .5 * eb) + .5);
					...
					b.mobile && db(1.4); {
						...
						for (let O = ma.length - 1; 0 <= O; O--) {
							...
							let la = Math.max(0, Math.min(1, ja / 300,
								Ga / 300));
					...
					b.mobile && db(.8); {
							...
							Ga = (pa, Da, R, Ha, Ua) => {
								...
								if (!L.S) {
									...
									for (let Bb = 0; Bb < Za; Bb++)
										for (let Cb =
											0; Cb < sa; Cb++) x.globalAlpha = .5, x.fillStyle = ib(L.Z[Bb][Cb]), Ta(pa + Cb * fb, Da + Bb * sb, fb, sb)
								}
								x.globalAlpha = 1;
								x.save();
								x.beginPath();
						...
						if (b.mobile) {
							...
							let Da = (Ha, Ua, sa, Za, fb, sb) => {
								...
								x.globalAlpha = 1;
								X.get(Ha).i(sb, Ua + Za / 2, sa + .725 * fb,
									.6 * fb, D(8), "center");
								x.strokeStyle = D(9);
								x.lineWidth = 3;
								Ta(Ua, sa, Za, fb, !0)
					...
					if (!T.h.Oa && T.J.Kb) {
						...
						for (let z = 0; z < ub.data.length && (!b.mobile ||
							6 > z); z++) {
							let O = ub.data[z];
							...
							pb(K - 21 - Ga * O.position.W.x * Math.SQRT1_2, J + 7 + Ga * O.position.W.x * Math.SQRT1_2, O.image, .5, 1, 2 * Ga / O.image.size, -Math.PI /
								4, !0);
							J += 18
						}
					}
						...
						if (b.sa) {
							...
							for (let R of f.ra) {
								...
								let Ha = A(R, f.color),
									Ua = Ia[R].position,
									sa = .6 * J / Ua.axis;
								pb(O + .5 * J - sa * Ua.W.x * Math.cos(qa), U + .5 * z - sa * Ua.W.x * Math.sin(qa),
									Ha, 1, 1, sa / Ha.size, qa, !0);
						...
						if (b.ma) {
							for (let ja = 0; ja < f.F.length; ja++) {
								...
								let ra = Ga.amount,
									...
									[Ha,
										Ua
									] = 1 === Da.length ? [Da, null] : [Da.slice(0, R).join(" "), Da.slice(R).join(" ")];
								x.globalAlpha = .5;
								x.fillStyle = Ca;
								Ta(O, ia, J, 2 * z / 3);
								x.globalAlpha = .1;
								...
								Ua ? (S[ja].i(Ua, O + J / 2, ia + .55 * z, z / 5, D(8), "center"),
									S[ja].i(Ha, O + J / 2, ia + .3 * z, z / 5, D(8), "center")) : S[ja].i(Ha, O + J / 2, ia + .425 * z, z / 5, D(8), "center");
			...
			lc = (() => {
				...
				let Q = () => {
					...
					E = 0 === E ? "\ud83c\udf3c" :
						4 > E ? "\ud83c\udfaf" : 8 > E ? "\ud83d\udca5" : 15 > E ? "\ud83d\udca2" : 25 > E ? "\ud83d\udd25" : 50 > E ? "\ud83d\udca3" : 75 > E ? "\ud83d\udc7a" : 100 > E ? "\ud83c\udf36\ufe0f" : "\ud83d\udcaf";
					let e = [],
						w = 0;
					for (let [F, H] of [
						[" kill", ""],
				...
				return () => {
					...
					c.i(`Level ${f.l.Dc()} ${Ia[f.type].name}`,
						e - 170, w - 30, 25, D(8));
					...
					b.na ? (b.u.na.Ca(0, (e - 60) * M, (w + 180) * M, 120 * M, 32 * M), x.globalAlpha = .5, x.fillStyle = D(16), Ta(e - 60, w + 180, 120,
						32), x.globalAlpha = .1, x.fillStyle = D(9), Ta(e - 60, w + 199.2, 120, 12.8), x.globalAlpha = 1, I.i(b.na.sc ? "Copied!" : "Copy Code", e, w + 202, 16, D(8), "center"), x.strokeStyle = D(9), x.lineWidth = 3, Ta(e - 60, w + 180, 120, 32, !0)) : b.u.na.H();
					E(1 / M, !0)
				}
			})();
		...
		window.$createProfile = (() => {
			...
			return (c, d = -1, g = 200, h = -Math.PI / 4) => {
				let y = x.canvas.width,
					B = x.canvas.height,
					I = x.canvas.width = g;
				g = x.canvas.height = g; - 1 === d ? x.clearRect(0,
					0, I, g) : (x.fillStyle = D(18), x.fillRect(0, 0, I, g), x.globalAlpha = .5, x.fillStyle = hb(d), Ta(0, 0, I, g), x.globalAlpha = .1, x.fillStyle = D(9), Ta(0, .6 * g, I, .4 * g), x.globalAlpha = 1);
				let Q = A(c, f.color);
				c = Ia[c].position;
				let S = .6 * I / c.axis;
		...
		let nb = new Date,
			cc = b.mobile ?
				0 : Math.max(0, 1 - Math.abs(nb.getTime() - new Date(nb.getFullYear() - (6 > nb.getMonth() ? 1 : 0), 11, 25)) / 20736E5);
		if (cc) {
		...
		let oc = "en-US" === navigator.language && -7 <= b.qa && -4 >= b.qa,
			...
			qc = 11 === nb.getMonth() && 31 === nb.getDate() || 0 === nb.getMonth() &&
				3 >= nb.getDate();
